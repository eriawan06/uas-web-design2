            ...
            <v-card flat>
                <v-container>
                    <v-form ref="form" lazy-validation>
                        ...
                        <v-select v-model="city_id" v-if="province_id>0" :items="citiesByProvince" item-text="city" 
                            item-value="id" label="City" persistent-hint single-line></v-select>
                    </v-form>
                    <v-card-actions>
        ...
        getServices() {
            ...
            .then((response) => {
                ...
                if (responseData.status!='error') {
                    ...
                    this.setCart(responseData.data.safe_carts)
                }
