    ...
    <v-card>
        ...
        <v-container fluid>
            <v-form ref="form" v-model="valid" lazy-validation>
                ...
                <v-text-field v-model="password" :append-icon="showPassowrd? 'visibility':'visibility_off'"
                ...
                <v-checkbox v-model="checkbox" :rules="[v => !!v || 'You must aggree to continue']" 
                label="Do you aggree with our Privacy Policy?" required></v-checkbox>
    ...
    data() {
        return {
            ...
            emailRules: [
                ...
                v => /([a-zA-Z0-9_]{1,})(@)([a-zA-Z0-9_]{2,}).([a-zA-Z0-9_]{1,})+/.test(v) || 'E-mail must be valid',
            ],
            checkbox: false,
        }
    },
